...
const EditLeagueModal = ({ league, onClose, onSave }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.country || !formData.leagueName) {
      alert('Please fill in all required fields');
      return;
    }

    // Create form data for submission (simulating API call)
    ...
    console.log('Updating league:', submissionData);
  ...
  // Get current logo image (either new upload or existing)
  const currentLogoSrc = logoPreview || 
    "https://api.builder.io/api/v1/image/assets/TEMP/b7ddb62eaa88bdec6f78f9dd8bd0875b26941a54?width=160";
    ...
    <div className="modal-overlay">
      <div className="modal-container">
        <div className="modal-header">
          ...
          <h2 className="modal-title">Edit League</h2>
        </div>
          ...
          <div className="form-fields">
            ...
            <div className="edit-logo-container">
              <div className="current-logo">
                <img 
                  src={currentLogoSrc}
                  alt="Current league logo" 
                />
                {logoPreview && (
                  <button type="button" className="remove-file-btn edit-remove" onClick={removeFile}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12 22.75C6.07 22.75 1.25 17.93 1.25 12C1.25 6.07 6.07 1.25 12 1.25C17.93 1.25 22.75 6.07 22.75 12C22.75 17.93 17.93 22.75 12 22.75ZM12 2.75C6.9 2.75 2.75 6.9 2.75 12C2.75 17.1 6.9 21.25 12 21.25C17.1 21.25 21.25 17.1 21.25 12C21.25 6.9 17.1 2.75 12 2.75Z" fill="#FCFCFC"/>
                      <path d="M9.17011 15.58C8.98011 15.58 8.79011 15.51 8.64011 15.36C8.35011 15.07 8.35011 14.59 8.64011 14.3L14.3001 8.63999C14.5901 8.34999 15.0701 8.34999 15.3601 8.63999C15.6501 8.92999 15.6501 9.40998 15.3601 9.69998L9.70011 15.36C9.56011 15.51 9.36011 15.58 9.17011 15.58Z" fill="#FCFCFC"/>
                      <path d="M14.8301 15.58C14.6401 15.58 14.4501 15.51 14.3001 15.36L8.64011 9.69998C8.35011 9.40998 8.35011 8.92999 8.64011 8.63999C8.93011 8.34999 9.41011 8.34999 9.70011 8.63999L15.3601 14.3C15.6501 14.59 15.6501 15.07 15.3601 15.36C15.2101 15.51 15.0201 15.58 14.8301 15.58Z" fill="#FCFCFC"/>
                    </svg>
                  </button>
                )}
                {!logoPreview && (
                  <div 
                    className={`logo-upload-overlay ${isDragOver ? 'drag-over' : ''}`}
                    onDrop={handleDrop}
                  ...
                  >
                    <input 
                      ...
                      id="logo-upload-edit"
                    />
                    <label htmlFor="logo-upload-edit" className="edit-upload-label">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="logo-info">
                ...
                <div className="file-description">
                  ...
                  {formData.logo && (
                    <><br /><span className="file-name">📎 {formData.logo.name}</span></>
                  )}
                </div>
              </div>
            </div>
